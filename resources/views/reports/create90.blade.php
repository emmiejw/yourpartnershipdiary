...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 ">
                <div class="card">
                    <div class="card-header"><center><b>{{Auth::user()->name}} 3 monthly Report</b></center></div>
                    <div class="card-body">
                        <center>
                            <a href="{{ URL::route('diaries.index') }}" class="btn btn-info" style="margin-bottom: 10px;">Return to Your Diary</a>
                        </center>
