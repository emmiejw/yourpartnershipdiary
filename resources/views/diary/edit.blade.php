    ...
    <div class="row justify-content-center">
        <div class="col-md-12 ">
            <div class="card">
                ...
                <br>
                <center>
                    <a href="{{ URL::route('diaries.index') }}" class="btn btn-info" style="margin-bottom: 10px;">Return
                        to Diary</a>
                </center>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    <form method="post" action="{{ route('diaries.update', $diary->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="missed_alert"
                                value="{{$diary->missed_alert}}" />
                        </div>
                        <div class="form-group">
                            <label for="in_range">Did your Dog alerted when you was in range? Please give
                                details:</label>
