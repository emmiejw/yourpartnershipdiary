        ...
        <div class="col-sm-12 ">
            <div class="card">
                <div class="card-header" style="font-size: 18px;">
                    <center><b>Blood Glucose and Alert Diary</b></center>
                </div>
                <br>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    <form method="post" action="{{ route('diaries.store') }}">
                        ...
                        <div class="form-group">
                            <label for="bg_level">BG Level (mmols):</label>
                            <input type="number" class="form-control" name="bg_level" step="0.1" placeholder="6.5"
                                required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="in_range">Did your Dog alerted where you was in range? Please give
                                details:</label>
